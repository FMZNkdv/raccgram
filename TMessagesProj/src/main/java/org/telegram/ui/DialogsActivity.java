    ...
    public View createView(final Context context) {
        ...
        if (onlySelect) {
            ...
            if (folderId != 0) {
                ...
                logoDrawable = context.getResources().getDrawable(R.drawable.racclogo).mutate();
                int logoSize = dp(26);
                logoDrawable.setBounds(0, 0, logoSize, logoSize);
                SpannableStringBuilder ssb = new SpannableStringBuilder("R ");
...
//            }
    ...
    public ArrayList<TLRPC.Dialog> getDialogsArray(int currentAccount, int dialogsType, int folderId, boolean frozen) {
        ...
        if (dialogsType == DIALOGS_TYPE_DEFAULT) {
            return RaccgramConfig.getInstance().filterProxySponsor(messagesController.getDialogs(folderId), messagesController);
